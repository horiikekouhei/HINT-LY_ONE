export const hi = {
  ...
  contact: {
    ...
    nameLabel: "डेवलपर",
    emailLabel: "ईमेल पता",
    description: "यदि आपके पास HINT-LY ONE के लिए कोई प्रश्न, बग रिपोर्ट या सुझाव हैं, तो कृपया बेझिझक हमसे निम्नलिखित पते पर संपर्क करें।",
    respondTime: "हम आमतौर पर 3 व्यावसायिक दिनों के भीतर जवाब देते हैं।"
  }
};
